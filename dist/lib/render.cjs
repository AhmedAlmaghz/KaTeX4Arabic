...
function buildCssClasses(options) {
  const opts = resolveOptions(options);
...
function wrapWithArabicStyles(html, options) {
  const opts = resolveOptions(options);
  const classes = buildCssClasses(opts);
  return `<span class="${classes.join(" ")}" dir="${opts.direction}" style="font-family:'${opts.fontFamily}','KaTeX_Main',serif;direction:${opts.direction};--ka-op-scale:${opts.operatorScale};">${html}</span>`;
}
...
exports.ARABIC_MATH_UNICODE = ARABIC_MATH_UNICODE;
exports.ARROW_SYMBOLS = ARROW_SYMBOLS;
exports.BRACKET_SYMBOLS = BRACKET_SYMBOLS;
exports.COMPARISON_SYMBOLS = COMPARISON_SYMBOLS;
exports.DEFAULT_OPTIONS = DEFAULT_OPTIONS;
exports.DIFFERENTIAL_PATTERNS = DIFFERENTIAL_PATTERNS;
exports.FUNCTION_MAP = FUNCTION_MAP;
exports.GREEK_MAP = GREEK_MAP;
...
exports.convertNumbersInText = convertNumbersInText;
exports.formatArabicNumber = formatArabicNumber;
exports.fromArabicNumerals = fromArabicNumerals;
exports.getArabicMacros = getArabicMacros;
exports.isArabicDigit = isArabicDigit;
exports.processArabicLatex = processArabicLatex;
exports.processLatex = processLatex;
exports.renderArabic = renderArabic;
exports.renderArabicBatch = renderArabicBatch;
exports.renderArabicToString = renderArabicToString;
exports.renderArabicWithMeta = renderArabicWithMeta;
exports.resolveOptions = resolveOptions;
exports.toArabicNumerals = toArabicNumerals;
exports.translateAll = translateAll;
exports.translateDifferentials = translateDifferentials;
exports.translateFunctions = translateFunctions;
exports.translateSpecialPatterns = translateSpecialPatterns;
exports.translateVariables = translateVariables;
