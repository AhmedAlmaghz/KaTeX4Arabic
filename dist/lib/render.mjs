...
export {
  ...
  resolveOptions as d,
  applyMirroredSymbols as e,
  translateSpecialPatterns as f,
  getArabicMacros as g,
  translateDifferentials as h,
  translateVariables as i,
  translateFunctions as j,
  isArabicDigit as k,
  convertNumbersInText as l,
  formatArabicNumber as m,
  fromArabicNumerals as n,
  toArabicNumerals as o,
  processArabicLatex as p,
  processLatex as q,
  renderArabicWithMeta as r,
  renderArabicToString as s,
  translateAll as t,
  renderArabic as u,
  validateLatex as v,
  ARROW_SYMBOLS as w,
  DIFFERENTIAL_PATTERNS as x,
  MIRRORED_SYMBOLS as y
};
