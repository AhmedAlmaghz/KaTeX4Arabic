...
export {
  ...
  renderArabicToString as d,
  renderArabic as e,
  ARROW_SYMBOLS as f,
  DIFFERENTIAL_PATTERNS as g,
  MIRRORED_SYMBOLS as h,
  applyMirroredSymbols as i,
  buildCssClasses as j,
  convertNumbersInText as k,
  formatArabicNumber as l,
  fromArabicNumerals as m,
  getArabicMacros as n,
  isArabicDigit as o,
  ...
  translateDifferentials as u,
  validateLatex as v,
  translateFunctions as w,
  translateSpecialPatterns as x,
  translateVariables as y
};
