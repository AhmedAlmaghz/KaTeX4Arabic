...
export const equationGroups: EquationGroup[] = [
  ...
  },
  {
    ...
    equations: [
      ...
      },
      {
        ...
        description: 'رموز العضوية والمجموعة الجزئية (تُعرض بالاتجاه العربي).',
        icon: '∈',
        borderColor: 'border-teal-500',
      },
      {
        title: 'رموز المجموعات (يونيكود)',
        latex: 'س ∈ م, \\quad أ ⊆ ب, \\quad س ∉ م',
        description: 'كتابة الرموز كمحارف مباشرة — تُعكس تلقائياً كذلك.',
        icon: '∋',
        borderColor: 'border-green-500',
      },
      {
  ...
  },
  {
    ...
    equations: [
      {
        title: 'الاحتمال الكلاسيكي (لابلاس)',
        latex: 'P(A) = \\frac{n(A)}{n(\\Omega)}',
        description: 'عدد النواتج الملائمة مقسوماً على عدد النواتج الممكنة.',
        icon: '🎲',
        borderColor: 'border-amber-500',
      },
      {
        title: 'قانون الجمع للاحتمال',
        latex: 'P(A \\cup B) = P(A) + P(B) - P(A \\cap B)',
        description: 'احتمال اتحاد حدثين متداخلين.',
        icon: '➕',
        borderColor: 'border-orange-500',
      },
      {
        ...
        description: 'احتمال الحدث A بشرط وقوع الحدث B.',
        icon: '🎯',
        borderColor: 'border-red-500',
      },
      {
        ...
        description: 'تحديث الاحتمال المسبق عند توفر معطى جديد.',
        icon: '🔄',
        borderColor: 'border-rose-500',
      },
      {
        ...
        description: 'المتوسط المرجح لقيم متغير عشوائي باحتمالاته.',
        icon: '⚖️',
        borderColor: 'border-yellow-500',
      },
      {
        title: 'التوزيع ذو الحدين',
        latex: 'P(X = k) = \\binom{n}{k} p^k (1-p)^{n-k}',
        description: 'احتمال تحقق k نجاحةً في n تجربة مستقلة.',
        icon: '📈',
        borderColor: 'border-lime-500',
      },
      {
        title: 'الاحتمال الهندسي',
        latex: 'P = \\frac{\\text{القياس الملائم}}{\\text{القياس الكلي}}',
        description: 'الاحتمال الهندسي: نسبة القياس الملائم (طول/مساحة) إلى القياس الكلي.',
        icon: '📏',
        borderColor: 'border-emerald-500',
      },
    ],
    ...
    equations: [
      {
        ...
        latex: 'a^2 + b^2 = c^2',
        description: 'العلاقة بين أضلاع المثلث القائم: مربع الوتر يساوي مجموع مربعي الضلعين القائمين.',
        icon: '📐',
        borderColor: 'border-emerald-500',
      },
      {
        ...
        description: 'مساحة الدائرة ومحيطها بدلالة نصف القطر.',
        icon: '⭕',
        borderColor: 'border-cyan-500',
      },
      {
        ...
        description: 'إيجاد ضلع مثلث بدلالة الضلعين والزاوية المحصورة بينهما.',
        icon: '📐',
        borderColor: 'border-blue-500',
      },
      {
        title: 'قانون جيب الزوايا',
        latex: '\\frac{a}{\\sin(\\alpha)} = \\frac{b}{\\sin(\\beta)} = \\frac{c}{\\sin(\\gamma)}',
        description: 'النسبة الثابتة بين ضلع المثلث وجيب الزاوية المقابلة له.',
        icon: '🔺',
        borderColor: 'border-violet-500',
      },
      {
        title: 'مساحة المثلث (صيغة هيرون)',
        latex: 'S = \\sqrt{p(p-a)(p-b)(p-c)}, \\quad p = \\frac{a+b+c}{2}',
        description: 'مساحة المثلث بدلالة أضلاعه الثلاثة حيث p نصف المحيط.',
        icon: '📐',
        borderColor: 'border-teal-500',
      },
      {
        ...
        description: 'تطبيق مباشر لفيثاغورس في المستوى الإحداثي.',
        icon: '📍',
        borderColor: 'border-fuchsia-500',
      },
      {
        title: 'حجم ومساحة الكرة',
        latex: 'V = \\frac{4}{3}\\pi r^3, \\quad S = 4\\pi r^2',
        description: 'حجم الكرة ومساحتها السطحية.',
        icon: '🔮',
        borderColor: 'border-purple-500',
      },
      {
        ...
        description: 'المجموع دائماً قائمتان (١٨٠ درجة) في المستوى الإقليدي.',
        icon: '📐',
        borderColor: 'border-sky-500',
      },
    ],
